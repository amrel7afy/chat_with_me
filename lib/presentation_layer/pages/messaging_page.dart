...
import 'package:chat_app/business_logic_layer/add_reciever_chat_data_cubit/add_reciever_chat_data_cubit.dart';
...
import 'package:chat_app/presentation_layer/widgets/loading_indicator.dart';
...
class MessagingPage extends StatefulWidget {
  ...
  const MessagingPage({Key? key, required this.friendModel}) : super(key: key);
...
class _MessagingPageState extends State<MessagingPage> {
  ...
  void initState() {
    ...
    //final AddRecieverChatDataCubit addRecieverChatDataCubit = locator<AddRecieverChatDataCubit>();
    AddRecieverChatDataCubit.getCubit(context).addRecieverChatData(widget.friendModel, context);
    super.initState();
  }
